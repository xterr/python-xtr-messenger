...
from xtr_messenger.exception import UnknownTransportError
from xtr_messenger.message_registry import transports_of
from xtr_messenger.stamp import TransportNamesStamp
...
class SendersLocator(SendersLocatorInterface):
    ...
    1. A :class:`~xtr_messenger.stamp.TransportNamesStamp` on the envelope,
    ...
    4. The ``transport`` declared on the message by
       :func:`~xtr_messenger.decorator.as_message`.
