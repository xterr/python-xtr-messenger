...
one by advertising it under the ``message_bus.transport_factories`` entry
...
:class:`~message_bus.transport.transport_config.TransportConfig` of each
transport it is building, and reads
:attr:`~message_bus.transport.transport_config.TransportConfig.settings` off
...
ENTRY_POINT_GROUP = "message_bus.transport_factories"
